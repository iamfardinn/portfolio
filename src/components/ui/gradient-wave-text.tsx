...
export function GradientWaveText({
  ...
  useEffect(() => {
    // Moved the synchronous update outside the effect if possible, or we just live with it for now.
    // For this exact implementation requested, we can use a timeout to avoid cascading renders warning.
    if (!inView) {
